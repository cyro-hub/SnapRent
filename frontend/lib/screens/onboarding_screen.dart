...
import 'package:snap_rent/screens/main_navigation.dart';
...
2. We are not liable for any losses from transactions.
3. Your personal data will be handled according to our privacy policy.
4. Do not use the app for illegal activities.
5. We reserve the right to terminate accounts that violate these rules.
